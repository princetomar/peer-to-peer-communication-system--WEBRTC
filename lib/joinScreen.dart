...
import 'package:streamingtest/homeCallScreen.dart';
...
class _JoinScreenState extends State<JoinScreen> {
  ...
  void initState() {
    ...
    SignallingService.inst.socket!.on("newCall", (data) {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("peer-to-peer communication system"),
      ),
      body: SafeArea(
        child: Stack(
          children: [
